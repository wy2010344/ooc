...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/wy2010344/ooc
features:
  - title: 极简语法
    details: 没有函数调用，只有「给对象发消息」，用空格分隔消息名与参数。
    icon: ⚡
    link: /guide/01-basics
  - title: 对象与方法
    details: 对象、this、守卫 #guard、委托组合（withDefault）与嵌套对象，覆盖面向对象核心能力。
    icon: 📚
